    ...
    <div className="sticky top-0 z-[60] bg-amber-500 border-b border-amber-600 h-9 flex items-center overflow-hidden shadow-sm">
      ...
      <div className="shrink-0 flex items-center gap-0 border-l border-amber-400 bg-amber-600 h-full">
        <a
          ...
          className="flex items-center gap-1.5 px-3 h-full text-white font-bold text-xs hover:bg-amber-700 transition-colors whitespace-nowrap border-r border-amber-500"
        >
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-3.5 h-3.5 shrink-0">
            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.14 12 19.79 19.79 0 0 1 1.07 3.4 2 2 0 0 1 3.05 1.25h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 8.91a16 16 0 0 0 5.93 5.93l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21 16.92z"/>
          </svg>
          +251937595664
        </a>
      </div>
